    ...
    const populateMyPlansPlanDetail = (rec) => {
      ...
      if (activityEl) {
        ...
        const buildCard = (date, expanded, opts = {}) => {
          ...
          const activityRowsFooter = `<div class="my-plans-detail-panel__act-list-footer"><div class="my-plans-detail-panel__act-list-footer-divider" aria-hidden="true"></div><p class="my-plans-detail-panel__act-list-footer-text">${activityPaidWithText}</p></div>`;
